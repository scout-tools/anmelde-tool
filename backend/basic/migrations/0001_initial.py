# Generated by Django 3.1.4 on 2021-01-14 21:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='EatHabitPersonal',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('eat_habit_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='basic.eathabittype')),
                ('participantPersonal', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='basic.participantpersonal')),
            ],
        ),
        migrations.CreateModel(
            name='EatHabitGroup',
            fields=[
                ...
                ('number_of_persons', models.IntegerField(blank=True, null=True)),
                ('eat_habit_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='basic.eathabittype')),
                ('participantGroup', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='basic.participantgroup')),
            ],
        ),
    ]
